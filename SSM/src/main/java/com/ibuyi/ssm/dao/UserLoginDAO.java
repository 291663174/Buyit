...
public interface UserLoginDAO {
    ...
    int userRegister(String userAccount,String userPwd,String userName,String userGender,String userEmail,
                     String userPhoneNumber,String userCardNumber);
